    ...
    return(
       ...
       <View style={Styles.viewbox}>
        ...
        <View style={Styles.viewbox2}>
          <Text style={Styles.creditview}>Credit History</Text>
          <TouchableOpacity>
          <Text style={{ textAlign:'center',color:'black',padding:12,fontWeight:'bold'}}>Withdraw History</Text>
          </TouchableOpacity>
        </View>
